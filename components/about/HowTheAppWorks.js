        ...
        <Card className="no-background">
          <CardContent sx={{ lineHeight: "2rem" }}>
            ...
            <Typography variant="body">
              ...
              تقريباً الترتيب الموجود في آيات المواريث الموجودة في القرآن الكريم
              لتسهيل إختيار الورثة على مستخدم التطبيق، فهي ستبدأ بإختيار الأولاد
              و أولاد الأولاد ومن ثم الأباء و الزوج و الأجداد ومن بعدها الإخوة
              بأنواعهم (الأشقّاء و الأخوة لأب و الأخوة لأم) و أخيراً أبناء الأخ
